        ...
        <div className="login-background-image">
          <div className="login-page">
            <h2 className='membership'>{'로그인'}</h2>
              ...
              {error && (<div className='inputbox-message'>{"이메일 주소 포맷이 맞지않습니다."}</div>)}
              ...
              {error && (<div className='inputbox-message'>{"비밀번호가 맞지 않습니다."}</div>)}
            <div className="inputbox-label-box"></div>
            <div className="inputbox-label-box"></div>
            <div className="inputbox-label-box"></div>
            <div className="inputbox-label-box"></div>
            <div className='button-box'>
             <div className='nextpage' onClick={onSignInButtonClickHandler}>{'로그인'}</div>
            </div>
            <div className="membering">
              <div className="membering-msg">신규 사용자 이신가요?</div>
              <div className="membering-button" onClick={onSignUpClickHandler}>회원가입</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='inputbox'>
        <div className="login-background-image">
          <div className="login-page">
            ...
            <div className='button-box'>
             <div className='nextpage' onClick={onButtonClickHandler}>
             { page === 1 ? '다음 단계' : '회원가입' }
             </div>
            </div>
            <div className="membering">
              <div className="membering-msg">이미 계정이 있으신가요?</div>
              <div className="membering-button" onClick={onSignInClickHandler}>로그인</div>
            </div>
          </div>
        </div>
      </div>
